...
#python plot_measurements_config.py -i compare_FEM_timetraces_low.conf -d delay -n True -l 0.05 -u 0.12 -t "50 to 120MHz" -o ${plotdir}planewave_delay_FEM_lowband -z True
