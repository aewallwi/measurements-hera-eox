...
hybrid_coupler_A.read_files('../GreenBankMeasurements_FeedOnly_August_28th_2017/','_hybrid_A_port_A_antenna',
                            '../hybrid_coupler_A_Sierra/A_','','ANRITSU_CSV',
                            '1','3','4',0.05,0.25)
hybrid_coupler_B.read_files('../GreenBankMeasurements_FeedOnly_August_28th_2017/','_hybrid_B_port_A_antenna',
                            '../hybrid_coupler_B/1','','ANRITSU_CSV',
                            '1','3','4',0.05,0.25)
cambridge_balun.read_files('../GreenBankMeasurements_FeedOnly_August_28th_2017/','_cambridge_balun_N_antenna_0',
...
ax3.plot(hybrid_coupler_A.fAxis,hybrid_coupler_A.gain_frequency.real,color='k')
ax3.plot(hybrid_coupler_A.fAxis,hybrid_coupler_A.gain_frequency.imag,color='k',ls='--')
ax3.plot(hybrid_coupler_B.fAxis,hybrid_coupler_B.gain_frequency.real,color='grey')
ax3.plot(hybrid_coupler_B.fAxis,hybrid_coupler_B.gain_frequency.imag,color='grey',ls='--')
ax3.plot(cambridge_balun.fAxis,cambridge_balun.gain_frequency.real,color='r')
ax3.plot(cambridge_balun.fAxis,cambridge_balun.gain_frequency.imag,color='r',ls='--')


fig1.savefig('Sinuous_s11_amp_comarision_August_28th_2017.pdf')
fig2.savefig('Sinuous_s11_pha_comarision_August_28th_2017.pdf')
